...
public class ChemicalMiner {
    ...
    public static void main(String[] args) {
        ...
        File inputFile = new File("./output_files/pmid.txt"); //Input file with list of PMIDs for each species (from R code)
        ...
        File chemicalFile = new File("./output_files/chemical.tsv"); //Output file with chemical names for each species
